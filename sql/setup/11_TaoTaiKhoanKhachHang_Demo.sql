...
--
-- Quy ước: LoginName = CMND, Password = '123456' (demo)
...
CREATE LOGIN [1111111111] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
CREATE LOGIN [0011223344] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
PRINT N'[A] Đã tạo KH BENTHANH: 1111111111, 0011223344 (mật khẩu: 123456, role: KhachHang)';
GO
...
CREATE LOGIN [2222222222] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
CREATE LOGIN [0099887766] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
CREATE LOGIN [3333333333] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
CREATE LOGIN [4444444444] WITH PASSWORD = '123456', CHECK_EXPIRATION = OFF, CHECK_POLICY = OFF;
GO
USE NGANHANG;
...
PRINT N'[B] Đã tạo KH TANDINH: 2222222222, 0099887766, 3333333333, 4444444444 (mật khẩu: 123456, role: KhachHang)';
GO
